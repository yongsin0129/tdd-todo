...
| **3** | 前端開發 | 7-10 天 | 2025-10-18 | 2025-10-28 | ⏳ 待開始 |
...
| 任務 ID | 任務名稱 | 工作量 | 優先級 | 狀態 |
|---------|---------|-------|--------|------|
| **3.1** | 初始化 React + Vite 專案 | 4h | P0 | ⏳ 待開始 |
| **3.2** | 配置 Tailwind CSS | 2h | P0 | ⏳ 待開始 |
| **3.3** | 設置 Zustand Store | 4h | P0 | ⏳ 待開始 |
| **3.4** | 配置 Vitest + RTL 測試框架 | 4h | P0 | ⏳ 待開始 |
| **3.5** | 實作 TodoForm 組件 (TDD) | 8h | P0 | ⏳ 待開始 |
| **3.6** | 實作 TodoItem 組件 (TDD) | 8h | P0 | ⏳ 待開始 |
| **3.7** | 實作 TodoList 組件 (TDD) | 8h | P0 | ⏳ 待開始 |
| **3.8** | 整合後端 API | 6h | P0 | ⏳ 待開始 |
| **3.9** | 實作本地儲存 (localStorage) | 4h | P1 | ⏳ 待開始 |
| **3.10** | 響應式設計 (RWD) | 6h | P0 | ⏳ 待開始 |
| **3.11** | 無障礙設計 (a11y) | 6h | P0 | ⏳ 待開始 |
| **3.12** | 載入狀態與錯誤處理 | 4h | P1 | ⏳ 待開始 |
...
| Vitest | 2.0+ | 測試框架 |
| React Testing Library | 16.0+ | 組件測試 |
...
| **M3: 前端完成** | 2025-10-28 | 所有組件測試通過 | ⏳ 待達成 |
